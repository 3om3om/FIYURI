		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[FIYURI-MM] 자재 문서 조회",
									"targetURL": "#MMzbammdocument-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MMzbammdocument-display": {
								"semanticObject": "MMzbammdocument",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=MM.zbammdocument",
									"url": sap.ui.require.toUrl("MM/zbammdocument")
								}
							}
						}
					}
