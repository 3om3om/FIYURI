		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[MM] 입고 예정일 관리",
									"targetURL": "#MMzbammedate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MMzbammedate-display": {
								"semanticObject": "MMzbammedate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=MM.zbammedate",
									"url": sap.ui.require.toUrl("MM/zbammedate")
								}
							}
						}
					}
